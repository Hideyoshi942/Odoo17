...
class PlayerController(http.Controller):
  @http.route(['/football_resource/player', '/football_resource_two'], auth='public', type='http')
  def index(self):
    return "Hello, world"
  ...
  # @http.route('/football_resource', auth='public')
  # def index(self):
  ...
  # @http.route('/football_resource', auth='public', type='http')
